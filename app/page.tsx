...
export default function EcosystemDashboard() {
  ...
  const apps = [
    ...
    {
      id: "APP-28",
      name: "ELIZA-FORGE (SYNTH-OS)",
      path: "/eliza-agents",
      category: "SCF",
      categories: ["SCF", "CAT4"],
      badge: "AGENT LAUNCH OS",
      tollbooth: "X • TG • SOL • FAL • HIGGS",
      icon: Bot,
      color: "text-pink-300 bg-pink-950/80 border-pink-600 shadow-sm",
      desc: "Autonomous multi-modal agent studio: AI lifecycle configurator, Solana wallet manager, Fal.ai/Higgsfield asset synthesis, and owner curation & staging approval deck.",
    },
    {
      id: "APP-25",
